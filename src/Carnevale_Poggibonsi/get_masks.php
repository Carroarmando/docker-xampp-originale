...
$query = "  SELECT masks.mask_id, masks.name, COUNT(users.user_id) AS count FROM masks LEFT JOIN users ON masks.mask_id = users.mask_id GROUP BY masks.mask_id, masks.name";
$result = $conn->query($query);
