            ...
            fetch("get_links.php")
                ...
                .then(data => {
                    ...
                    data.forEach(link => {
                        ...
                        shorted_link_Div.textContent = "https://3000-idx-docker-xampp-1736234929524.cluster-6yqpn75caneccvva7hjo4uejgk.cloudworkstations.dev/LinkShortener2/redirect.php?l=" + link.link_id;
